...
export const GdxRuntimeException = {
    Ctor(message: string): NativePointer {
        ...
        return PatchHelper.GetNativeFunction(NativeGDXLibInfo.utils.RuntimeException.Ctor)(NULL, nativeMessage);
    },
    ...
    Ctor2(message: string, exceptPtr: NativePointer): NativePointer {
        let nativeMessage = NativeSTDLib.JString.Ctor(message);
        return PatchHelper.GetNativeFunction(NativeGDXLibInfo.utils.RuntimeException.Ctor2)(NULL, nativeMessage, exceptPtr);
    },
