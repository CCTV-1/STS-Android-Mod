...
namespace STS
{
    ...
    struct CardGroupVFuncMap
    {
        ...
        bool byte74;
        uint8_t gap75[3];
        dummyFunc_t removeCard;
        bool byte7C;
        uint8_t gap7D[3];
        dummyFunc_t removeCard2;
        bool byte84;
        uint8_t gap85[3];
        dummyFunc_t addToHand;
        bool byte8C;
        uint8_t gap8D[3];
        dummyFunc_t dword90;
        bool byte94;
        ...
        bool byteBC;
        uint8_t gapBD[3];
        dummyFunc_t addToRandomSpot;
        bool byteC4;
        uint8_t gapC5[3];
        dummyFunc_t getTopCard;
        bool byteCC;
        uint8_t gapCD[11];
        dummyFunc_t getBottomCard;
        bool byteDC;
        uint8_t gapDD[3];
        dummyFunc_t dwordE0;
        bool byteE4;
        uint8_t gapE5[3];
        dummyFunc_t getRandomCard;
        bool byteEC;
        uint8_t gapED[3];
        dummyFunc_t getRandomCard2;
        bool byteF4;
        uint8_t gapF5[3];
        dummyFunc_t getRandomCard3;
        bool byteFC;
        uint8_t gapFD[3];
        dummyFunc_t getRandomCard4;
        bool byte104;
        uint8_t gap105[3];
        dummyFunc_t getRandomCard5;
        bool byte10C;
        uint8_t gap10D[3];
        dummyFunc_t removeTopCard;
        bool byte114;
        uint8_t gap115[3];
        dummyFunc_t shuffle;
        bool byte11C;
        uint8_t gap11D[3];
        dummyFunc_t shuffle2;
        bool byte124;
        uint8_t gap125[3];
        ...
        bool byte164;
        uint8_t gap165[3];
        dummyFunc_t dword168;
        bool byte16C;
        uint8_t gap16D[3];
        dummyFunc_t dword170;
        bool byte174;
        uint8_t gap175[3];
        dummyFunc_t dword178;
        bool byte17C;
        uint8_t gap17D[19];
        dummyFunc_t moveToDiscardPile;
        bool byte194;
        uint8_t gap195[3];
        dummyFunc_t dword198;
        bool byte19C;
        uint8_t gap19D[3];
        dummyFunc_t moveToExhaustPile;
        bool byte1A4;
        uint8_t gap1A5[3];
        dummyFunc_t moveToHand;
        bool byte1AC;
        uint8_t gap1AD[3];
        dummyFunc_t moveToHand2;
        bool byte1B4;
        uint8_t gap1B5[3];
        dummyFunc_t moveToDeck;
        bool byte1BC;
        uint8_t gap1BD[3];
        dummyFunc_t moveToBottomOfDeck;
        bool byte1C4;
        uint8_t gap1C5[3];
        dummyFunc_t isEmpty;
        bool byte1CC;
        uint8_t gap1CD[3];
        dummyFunc_t dword1D0;
        bool byte1D4;
        uint8_t gap1D5[3];
        dummyFunc_t size;
        bool byte1DC;
        uint8_t gap1DD[3];
        dummyFunc_t dword1E0;
        bool byte1E4;
        uint8_t gap1E5[3];
        dummyFunc_t dword1E8;
        bool byte1EC;
        uint8_t gap1ED[3];
        dummyFunc_t dword1F0;
        bool byte1F4;
        uint8_t gap1F5[3];
        dummyFunc_t dword1F8;
        bool byte1FC;
        uint8_t gap1FD[3];
        dummyFunc_t dword200;
        bool byte204;
        uint8_t gap205[3];
        dummyFunc_t dword208;
        bool byte20C;
        uint8_t gap20D[3];
        dummyFunc_t dword210;
        bool byte214;
        uint8_t gap215[3];
